"""
Django settings for badger_buddy project.
...
SECRET_KEY = '@qktco1#5--x=)=)golvow_sh6_r^80656p&6h4t-2_jevs=p2'
...
ROOT_URLCONF = 'badger_buddy.urls'
...
WSGI_APPLICATION = 'badger_buddy.wsgi.application'
